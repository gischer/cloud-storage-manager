...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "vqpv9810jr6jpmxecgwmr1eqrtfk398xuq644z1t9nznxt645400",

  manifest = (
 
    appTitle = (defaultText = "Cloud Storage Manager"),
    ...
    metadata = (
      ...
      icons = (
        ...
        appGrid = (png = (dpi1x = embed "../assets/cloud_icon_128x128.png")),
        grain = (png = (dpi1x = embed "../assets/cloud_icon_24x24.png")),
        market = (png = (dpi1x = embed "../assets/cloud_icon_150x150.png")),
        marketBig = (png = (dpi1x = embed "../assets/cloud_icon_300x300.png")),
      ),

      website = "https://github.com/gischer/cloud-storage-manager",
      # This should be the app's main website url.

      codeUrl = "https://github.com/gischer/cloud-storage-manager",

      license = (none = void),
 
      categories = [webPublishing, developerTools],

      author = (

        contactEmail = "jay@gischer.net",
      ...
      shortDescription = (defaultText = "Manage bucket files"),
